...
public class UtilCryptography 
{
    ...
    private static final String CLAVE = "CONFI_GAMBALIT%198210_2017";
    ...
    public static String encriptar(String str) 
        ...
        public static void main(String arg[])
            throws Exception
        {
            //System.out.println(encriptar("bsegovia"));
        	
            System.out.println( desencriptar("H3ZvL2G7gyuMOjhJgnifJQ=="));
        }
