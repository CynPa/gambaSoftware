...
/*  13:    */ 
/*  14:    */ public class AutorizacionMensajes
/*  15:    */   implements Serializable
/*  16:    */ {
/*  17:    */   private Mensaje[] mensaje;
/*  18:    */   
/*  19:    */   public AutorizacionMensajes(Mensaje[] mensaje)
/*  20:    */   {
/*  21: 18 */     this.mensaje = mensaje;
/*  22:    */   }
/*  23:    */   
/*  24:    */   public Mensaje[] getMensaje()
/*  25:    */   {
/*  26: 28 */     return this.mensaje;
/*  27:    */   }
/*  28:    */   
/*  29:    */   public void setMensaje(Mensaje[] mensaje)
/*  30:    */   {
/*  31: 38 */     this.mensaje = mensaje;
/*  32:    */   }
/*  33:    */   
/*  34:    */   public Mensaje getMensaje(int i)
/*  35:    */   {
/*  36: 42 */     return this.mensaje[i];
/*  37:    */   }
/*  38:    */   
/*  39:    */   public void setMensaje(int i, Mensaje _value)
/*  40:    */   {
/*  41: 46 */     this.mensaje[i] = _value;
/*  42:    */   }
/*  43:    */   
...
/*  47:    */   {
/*  48: 51 */     if (!(obj instanceof AutorizacionMensajes)) {
/*  49: 51 */       return false;
/*  50:    */     }
/*  51: 52 */     AutorizacionMensajes other = (AutorizacionMensajes)obj;
/*  52: 53 */     if (obj == null) {
/*  53: 53 */       return false;
/*  54:    */     }
/*  55: 54 */     if (this == obj) {
...
/*  62: 60 */     if ((this.mensaje != null) || 
/*  63: 61 */       (other.getMensaje() != null)) {
/*  64: 61 */       if (this.mensaje == null) {
/*  65:    */         break label92;
/*  66:    */       }
/*  67:    */     }
/*  68:    */     label92:
/*  69: 63 */     boolean _equals = Arrays.equals(this.mensaje, other.getMensaje());
...
/*  83: 75 */     if (getMensaje() != null) {
/*  84: 76 */       for (int i = 0; i < Array.getLength(getMensaje()); i++)
/*  85:    */       {
/*  86: 79 */         Object obj = Array.get(getMensaje(), i);
/*  87: 80 */         if ((obj != null) && 
...
/*  95:    */   }
/*  96:    */   
/*  97: 91 */   private static TypeDesc typeDesc = new TypeDesc(AutorizacionMensajes.class, true);
/*  98:    */   
/*  99:    */   static
/* 100:    */   {
/* 101: 95 */     typeDesc.setXmlType(new QName("http://ec.gob.sri.ws.autorizacion", ">autorizacion>mensajes"));
/* 102: 96 */     ElementDesc elemField = new ElementDesc();
/* 103: 97 */     elemField.setFieldName("mensaje");
/* 104: 98 */     elemField.setXmlName(new QName("http://ec.gob.sri.ws.autorizacion", "mensaje"));
/* 105: 99 */     elemField.setXmlType(new QName("http://ec.gob.sri.ws.autorizacion", "mensaje"));
...
/* 125:    */   }
/* 126:    */   
/* 127:    */   public AutorizacionMensajes() {}
/* 128:    */ }


/* Location:           C:\backups\AS2(26-10-2017)\WEB-INF\classes\
 * Qualified Name:     ec.gob.sri.comprobantes.ws.autorizacion.AutorizacionMensajes
