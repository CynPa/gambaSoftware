...
/*  21:    */ @ManagedBean
/*  22:    */ @RequestScoped
/*  23:    */ public class ReportePagoVoucherBean
...
/*  30: 32 */   private final String COMPILE_FILE_NAME = "reportePagoVoucher";
/*  31:    */   
...
/*  36:    */     try
/*  37:    */     {
/*  38: 45 */       listaDatosReporte = this.servicioReporteCobroCliente.getReportePagoVoucher(AppUtil.getOrganizacion().getId(), getCobro().getIdCobro());
/*  39: 46 */       String[] fields = { "f_codigoAlterno", "f_nombre", "f_codigo", "f_baseImponibleDiferenteCero", "f_baseImponibleTarifaCero", "f_montoIva", "f_valor", "f_documentoReferencia", "f_lote", "f_fechaVoucher", "f_porcentajeComision", "f_valorComision", "f_impuestoComision", "f_valorPagadoCalculado", "f_valorPagado" };
/*  40:    */       
/*  41:    */ 
/*  42:    */ 
 ...
 * Qualified Name:     com.asinfo.as2.finaciero.cobros.reportes.ReportePagoVoucherBean
