...
@Local
public abstract interface ServicioDocumento
{
  ...
  public abstract List<Documento> buscarPorDocumentoBaseOrganizacion(DocumentoBase paramDocumentoBase, int paramInt)
    throws ExcepcionAS2;
  ...
  public abstract AutorizacionDocumentoSRI obtenerAutorizacionConSecuencia(Date paramDate, Documento paramDocumento, PuntoDeVenta paramPuntoDeVenta)
    throws ExcepcionAS2;
  
  public abstract List<AutorizacionDocumentoSRI> obtenerAutorizaciones(Date paramDate, int paramInt, boolean paramBoolean)
    throws ExcepcionAS2;
  
  public abstract List<Documento> buscarPorDocumentoBaseOrganizacionAerolinea(DocumentoBase paramDocumentoBase, int paramInt)
    throws ExcepcionAS2;
  
  public abstract List<Documento> buscarPorDocumentoBaseOrganizacion(DocumentoBase paramDocumentoBase, int paramInt, Integer paramInteger)
    throws ExcepcionAS2;
  
  public abstract void detach(Documento paramDocumento);
}


/* Location:           C:\backups\AS2(26-10-2017)\WEB-INF\classes\
 * Qualified Name:     com.asinfo.as2.datosbase.servicio.ServicioDocumento
